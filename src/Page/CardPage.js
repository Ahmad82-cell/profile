...
const projectsData = [
  ...
  {
    id: 4,
    title: "ABSHER-Wibsite",
    description: `A web platform for booking and managing Hajj and Umrah trips, allowing users to browse packages, make bookings easily, and providing an admin dashboard to manage trips and reservations`,
    category: "Web",
    image: hajj,
    demo: "https://absher-project1.netlify.app/",
    github: "https://github.com/",
    tags: [ "Bootstrap", "react","laravel"],
  },
];
          ...
          >
            <Col lg="6" md="12" sm="12">
              <h1 className="logoName2">
                <span style={{ color: "#BB86FC" }}>My </span>Project
              </h1>
            </Col>
          </Row>
